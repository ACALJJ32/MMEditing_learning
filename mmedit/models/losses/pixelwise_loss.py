...
class MultiStreamLoss(nn.Module):
    def __init__(self,
        ...
        # FocalFrequencyLoss
        self.facal_frequency_loss = FocalFrequencyLoss()
    ...
    def forward(self, pred, target, weight=None, **kwargs):
        ...
        pred_hr, input_lr, dual_img = pred

        loss_stream1 = self.loss_weight * charbonnier_loss(
            pred_hr,
            target,
            weight,
            eps=self.eps,
        ...
        # loss_stream2 = self.loss_weight * charbonnier_loss(
        #     input_lr,
        #     dual_img,
        #     weight,
        #     eps=self.eps,
